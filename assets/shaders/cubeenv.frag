...
// 环境贴图
vec3 calculateEnv(vec3 normalN, vec3 viewDir) {
     vec3 reflectDir = normalize(reflect(viewDir, normalN));
...
void main() {
    ...
    fragColor = vec4(diffuseColor + specularColor + ambientColor, alpha * opacity) ;
}
